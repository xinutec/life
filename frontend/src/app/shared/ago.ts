 ...
 *
 *  `now` is a parameter so a test can state the instant it means.
 *
 *  ⚠ **The unit is elapsed 24-hour periods, NOT calendar days**: something from
 *  23:00 last night reads as "today" at 09:00, because ten hours have passed.
 *  `ago.spec.ts` pins that; calendar days would be a product decision. */
