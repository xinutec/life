 ...
 */
export type Item = { id: number, product_id: ProductId | null, name: string, brand: string | null, category: ItemCategory, quantity: number | null, unit: string | null, expiry: string | null, location_id: number | null, barcode: string | null, 
/**
